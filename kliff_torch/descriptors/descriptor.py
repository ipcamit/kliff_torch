...
from kliff_torch.utils import create_directory, pickle_dump, to_path
...
class Descriptor:
    ...
    :class:`~kliff_torch.descriptors.SymmetryFunction` and
    :class:`~kliff_torch.descriptors.Bispectrum` can be used to transform the atomic environment
    ...
    def _welford_mean_and_stdev(self, configs: List[Configuration]):
        ...
        Args:
            configs: Dataset class:`~kliff_torch.dataset.Configuration`.
