...
import numpy as np
from kliff_torch.descriptors.descriptor import (
    Descriptor,
    generate_full_cutoff,
    generate_species_code,
    generate_unique_cutoff_pairs,
)
from kliff_torch.descriptors.symmetry_function import sf  # C extension
...
class SymmetryFunction(Descriptor):
    ...
    def transform(self, conf, fit_forces=False, fit_stress=False):
        ...
        Parameters
        ----------
        conf: :class:`~kliff_torch.dataset.Configuration` object
