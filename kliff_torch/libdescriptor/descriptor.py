...
AvailableDescriptors = {
        "SymmetryFunction": lds.AvailableDescriptors.SymmetryFunctions,
        "Bispectrum": lds.AvailableDescriptors.Bispectrum
    }
...
class Descriptor:
    ...
    def show_available_descriptors():
        for i, key in enumerate(Descriptor.AvailableDescriptors.keys()):
            print(f"{i}: {key}")
